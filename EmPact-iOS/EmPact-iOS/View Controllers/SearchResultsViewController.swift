...
class SearchResultsViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, UISearchBarDelegate {
    ...
    override func viewDidLoad() {
        ...
        if networkController?.tempCategorySelection == "" || networkController?.tempCategorySelection == nil {
            ...
            searchedTitleLabel.text = "\(selectedSubcategory.uppercased()) | \(unwrappedTempCategorySelection.uppercased()) within New York City, NY"
        }
    }
    ...
    func setupTheme() {
        ...
        searchedView.backgroundColor = UIColor.customDarkPurple
        searchedTitleLabel.backgroundColor = .customDarkPurple
        searchedView.layer.cornerRadius = 5
        
        self.tableView.separatorStyle = UITableViewCell.SeparatorStyle.none
        searchedTitleLabel.setViewShadow(color: UIColor.black, opacity: 0.3, offset: CGSize(width: 0, height: 1), radius: 1, viewCornerRadius: 0)
    }
}
